...
public class ClothesList extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //Update or delete the details on long press
    ...
    Button btnUpdate;
    //Dialoge box where user can change the details
    private void showDialogUpdate(Activity activity, final int position){
        ...
        //Updating the details in databse
                ...
                if (edtName.getText().toString().equals("")||edtPrice.getText().toString().equals("")|| edtDetails.getText().toString().equals("")) {
                    ...
                    try {
                        ...
                        MainActivity.sqLiteHelper.updateData(
                                ...
                                PostAd.imageViewToByte(imageViewClothes),
                                position
                        );
                        dialog.dismiss();
    ...
    //If user wants to update the post
    ...
    //Request to access camera and photos to uplod picture
    @Override
    ...
    //Notification is sent to users when there is a drop in price
    ...
    public void onClickHome(View view){
        ...
        Intent intent = new Intent(ClothesList.this, MainActivity.class);
