...
public class PostAd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChoose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityCompat.requestPermissions(PostAd.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},REQUEST_CODE_GALLERY);
            }
        });
        btnAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Vaidating if user has entered all details or not
                if (editName.getText().toString().equals("")||editPrice.getText().toString().equals("")|| editDetails.getText().toString().equals("")) {
                    ...
                    try {
                        //Fetching the data user has entered and storing it into the database
        ...
        btnList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    Intent intent=new Intent(PostAd.this,ClothesList.class);
    ...
    //Request to access camera and photos
    @Override
    ...
    //Notification is sent when user posts the add
